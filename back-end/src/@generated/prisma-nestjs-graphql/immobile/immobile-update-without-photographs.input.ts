...
import { UserUpdateOneWithoutImmobilesNestedInput } from '../user/user-update-one-without-immobiles-nested.input';
...
@InputType()
export class ImmobileUpdateWithoutPhotographsInput {
    ...
    @Field(() => UserUpdateOneWithoutImmobilesNestedInput, {nullable:true})
    record?: UserUpdateOneWithoutImmobilesNestedInput;
